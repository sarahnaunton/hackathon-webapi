...
const divCocktailContainerEl = document.querySelector(".cocktail__container")
...
selectionEl.addEventListener("change", async (event) => {
    divCocktailEl.innerHTML = "";
    const choice = event.target.value;
    console.log(choice)

    try{
        const responseChoice = await axios.get(`https://www.thecocktaildb.com/api/json/v1/1/search.php?s=${choice}`)
